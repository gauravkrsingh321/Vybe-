...
const ReelCard = ({ reel }) => {
  ...
  return (
    <div className="w-[420px] h-screen flex items-center justify-center border-l-2 border-r-2 border-gray-800 relative overflow-hidden">
      ...
      <div className={`absolute z-200 bottom-0 w-full h-[500px] p-2.5 rounded-t-4xl bg-[#0e1718] left-0 shadow-2xl transform transition-transform duration-500 ease-in-out shadow-black ${showComment ? "translate-y-0":"translate-y-full"}`}>
